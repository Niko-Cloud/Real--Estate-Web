...
const EditListing = () => {
    ...
    return (
        <main className="max-w-md px-2 mx-auto">
            <h1 className="text-3xl font-bold text-center mt-6">Edit a Listing</h1>
            <form onSubmit={onSubmit}>
                ...
                <button type="submit" className="mb-6 w-full bg-blue-600 rounded text-lg text-white px-6 py-2 uppercase shadow-md hover:bg-blue-700 hover:shadow-lg transition duration-200 ease-in-out foucs:bg-blue-800 focus:shadow-lg active:bg-blue-900 active:shadow-lg">Edit Listing</button>
            </form>
        </main>
    );
};
